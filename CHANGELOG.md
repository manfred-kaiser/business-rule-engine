...
- `RuleParser.unregister_function(name)`: remove a registered custom function by name; raises `KeyError` if not found
- `RuleParser.clear_functions()`: remove all registered custom functions
